...
namespace Resources.Areas.Administration.Contests.Views {
    ...
    public class ChangeTime {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Users who started competing &lt;strong&gt;after&lt;/strong&gt; this time will be affected (The default value is set to the current time minus the participant full contest duration minus another thirty minutes as buffer time).
        /// </summary>

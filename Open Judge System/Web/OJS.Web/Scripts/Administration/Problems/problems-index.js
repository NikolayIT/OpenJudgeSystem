    ...
    .then(function () {
        ...
        $('#problems-grid').kendoGrid({
            ...
            columns: [
                ...
                { field: "MaximumPoints", title: "Точки" },
                { field: "Checker", title: "Чекер" },
                { title: "Операции", width: "35%", template: '<a href="/Administration/Problems/Details/#= Id #" class="btn btn-sm btn-primary">Детайли</a>&nbsp;<a href="/Administration/Tests/Problem/#= Id #" class="btn btn-sm btn-primary">Тестове</a>&nbsp;<button class="btn btn-sm btn-primary resource-btn" id="resource-btn-#= Id #">Ресурси</button>&nbsp;<a href="/Administration/Problems/Edit/#= Id #" class="btn btn-sm btn-primary">Промяна</a>&nbsp;<a href="/Administration/Problems/Delete/#= Id #" class="btn btn-sm btn-primary">Изтриване</a>' },
            ],

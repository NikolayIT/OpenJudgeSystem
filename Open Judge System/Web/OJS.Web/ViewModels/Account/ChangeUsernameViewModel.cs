namespace OJS.Web.ViewModels.Account
{
    ...
    public class ChangeUsernameViewModel
    {
        [StringLength(15, ErrorMessageResourceName = "Username_validation",
            ErrorMessageResourceType = typeof(Resources.Account.ViewModels), MinimumLength = 5)]
        [Required(ErrorMessageResourceName = "Username_required",
            ErrorMessageResourceType = typeof(Resources.Account.ViewModels))]
        [Display(Name = "Username", ResourceType = typeof(Resources.Account.ViewModels))]
        ...
        [Compare("Username", ErrorMessageResourceName = "Username_confirmation_incorrect",
            ErrorMessageResourceType = typeof(Resources.Account.ViewModels))]
        [Display(Name = "Username_confirmation", ResourceType = typeof(Resources.Account.ViewModels))]

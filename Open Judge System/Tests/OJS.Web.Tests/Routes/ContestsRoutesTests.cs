namespace OJS.Web.Tests.Routes
{
    ...
    public class ContestsRoutesTests : RoutesTestsBase
    {
        ...
        {
            var routeData = this.GetAreaRouteData("~/Contests/Compete/Results/11", new ContestsAreaAreaRegistration());
        ...
        {
            var routeData = this.GetAreaRouteData("~/Contests/Practice/Results/12", new ContestsAreaAreaRegistration());
        ...
        {
            var routeData = this.GetAreaRouteData("~/Contests/Compete/FullResults/11", new ContestsAreaAreaRegistration());

            Assert.IsNotNull(routeData);
            Assert.AreEqual("Compete", routeData.Values["controller"]);
            Assert.AreEqual("FullResults", routeData.Values["action"]);
            Assert.AreEqual("11", routeData.Values["id"]);
            Assert.IsTrue((bool)routeData.Values["official"]);
        }
        ...
        {
            var routeData = this.GetAreaRouteData("~/Contests/Practice/FullResults/12", new ContestsAreaAreaRegistration());
